...
export const config = {
  ...
  streaming: {
    ...
    onDemandIdleTimeoutSec: parseInt(process.env.ON_DEMAND_IDLE_TIMEOUT_SEC || '120', 10),
    onDemandViewerPulseSec: parseInt(process.env.ON_DEMAND_VIEWER_PULSE_SEC || '90', 10),
    onDemandIdleCheckSec: parseInt(process.env.ON_DEMAND_IDLE_CHECK_SEC || '30', 10),
